...
### 1.启动ranger admin报错：[E] 007-updateBlankPolicyName.sql import failed!
更改msyql数据的参数：
...
### 2.启动ambari agent后，Service和host状态提示黄色问号
...
### 3. python 问题，unknown locale: UTF-8解决方法
...
### 4. zookeeper启动报错：Could not configure server because SASL configuration did not allow the ZooKeeper server to authenticate itself properly: javax.security.auth.login.LoginException: Receive timed out
...
### 6. hive view查询报错 “S020 Data storage error ”
...
防火墙检查
```
[root@cvm-da-datasvr-whd3 bin]# systemctl status firewalld.service
● firewalld.service - firewalld - dynamic firewall daemon
   Loaded: loaded (/usr/lib/systemd/system/firewalld.service; disabled; vendor preset: enabled)
   Active: inactive (dead)
[root@cvm-da-datasvr-whd3 bin]# systemctl status iptables.service
● iptables.service
